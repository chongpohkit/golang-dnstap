...
const (
	SocketProtocol_UDP SocketProtocol = 1 // User Datagram Protocol (RFC 768)
	SocketProtocol_TCP SocketProtocol = 2 // Transmission Control Protocol (RFC 793)
)
...
type Message struct {
	...
	SubscriberId []byte  `protobuf:"bytes,15,opt,name=subscriber_id,json=subscriberId" json:"subscriber_id,omitempty"` // 32 bytes
	LocalId      *uint64 `protobuf:"varint,16,opt,name=local_id,json=localId" json:"local_id,omitempty"`               // 8 bytes
	PcpSsp       []byte  `protobuf:"bytes,17,opt,name=pcp_ssp,json=pcpSsp" json:"pcp_ssp,omitempty"`                   // 16 bytes
	ProxyAll     []byte  `protobuf:"bytes,18,opt,name=proxy_all,json=proxyAll" json:"proxy_all,omitempty"`             // Proxy all
	Fqdn         []byte  `protobuf:"bytes,19,opt,name=fqdn" json:"fqdn,omitempty"`                                     // MAX 255 bytes
	Txid         *uint32 `protobuf:"varint,20,req,name=txid" json:"txid,omitempty"`                                    //16-bit transaction id
}
...
func (x *Message) GetSubscriberId() []byte {
	if x != nil {
...
func (x *Message) GetProxyAll() []byte {
	if x != nil {
		return x.ProxyAll
	}
	return nil
...
var file_dnstap_proto_rawDesc = []byte{
	...
	0x53, 0x41, 0x47, 0x45, 0x10, 0x01, 0x22, 0x90, 0x08, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	,
	...
	0x54, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x49, 0x4e, 0x45, 0x54, 0x36, 0x10, 0x02, 0x2a, 0x22,
